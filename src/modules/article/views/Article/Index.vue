...
import { batchDelete, page, realDelete, recovery } from '~/article/api/Article.ts'
...
defineOptions({ name: 'article:article' })
    ...
    <MaProTable ref="proTableRef" :options="options" :schema="schema">
      ...
      <template #toolbarLeft>
        <el-button-group>
          ...
          <el-button
            v-if="isRecovery"
            v-auth="['article:article:recovery']"
            type="success"
            plain
            :disabled="selections.length < 1"
