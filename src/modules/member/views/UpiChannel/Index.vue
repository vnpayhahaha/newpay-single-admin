...
import { deleteByIds, page } from '~/member/api/UpiChannel.ts'
...
defineOptions({ name: 'upi_channel' })
...
const options = ref<MaProTableOptions>({
  ...
  header: {
    mainTitle: () => local('UpiChannel.lable'),
  },
  // 表格参数
  tableOptions: {
    on: {
