...
import { create, save } from '~/member/api/MemberTronTransactionRecord.ts'
...
const { formType = 'add', data = null } = defineProps<{
  formType: 'add' | 'edit'
  data?: MemberTronTransactionRecordVo | null
}>()

const t = useTrans().globalTrans
const maFormRef = ref<MaFormExpose>()
const formModel = ref<MemberTronTransactionRecordVo>({})
