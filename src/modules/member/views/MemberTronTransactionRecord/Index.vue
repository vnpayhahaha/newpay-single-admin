...
import { deleteByIds, page } from '~/member/api/MemberTronTransactionRecord.ts'
...
defineOptions({ name: 'members:member_tron_transaction_record' })
...
const options = ref<MaProTableOptions>({
  ...
  header: {
    mainTitle: () => t('MemberTronTransactionRecord.lable'),
  },
  // 表格参数
  tableOptions: {
    on: {
...
<template>
  <div class="mine-layout pt-3">
    <MaProTable ref="proTableRef" :options="options" :schema="schema">
      <template #actions>
        <el-button
          v-auth="['members:member_tron_transaction_record:save']"
          type="primary"
          @click="() => {
      ...
      <template #toolbarLeft>
        <el-button
          v-auth="['members:member_tron_transaction_record:delete']"
          type="danger"
          plain
