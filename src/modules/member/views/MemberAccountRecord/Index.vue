...
import { deleteByIds, page } from '~/member/api/MemberAccountRecord.ts'
...
defineOptions({ name: 'members:member_account_record' })
...
const options = ref<MaProTableOptions>({
  ...
  header: {
    mainTitle: () => t('MemberAccountRecord.lable'),
  },
  // 表格参数
  tableOptions: {
    on: {
...
<template>
  <div class="mine-layout pt-3">
    <MaProTable ref="proTableRef" :options="options" :schema="schema">
      <template #actions>
        <el-button
          v-auth="['members:member_account_record:save']"
          type="primary"
          @click="() => {
      ...
      <template #toolbarLeft>
        <el-button
          v-auth="['members:member_account_record:delete']"
          type="danger"
          plain
