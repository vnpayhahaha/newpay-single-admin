...
import { deleteByIds, page } from '~/member/api/MemberAccount.ts'
...
defineOptions({ name: 'members:member_account' })
...
const options = ref<MaProTableOptions>({
  ...
  header: {
    mainTitle: () => t('MemberAccount.lable'),
  },
  // 表格参数
  tableOptions: {
    on: {
...
<template>
  <div class="mine-layout pt-3">
    <MaProTable ref="proTableRef" :options="options" :schema="schema">
      <template #actions>
        <el-button
          v-auth="['members:member_account:save']"
          type="primary"
          @click="() => {
      ...
      <template #toolbarLeft>
        <el-button
          v-auth="['members:member_account:delete']"
          type="danger"
          plain
