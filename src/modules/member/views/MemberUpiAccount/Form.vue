...
import { create, save } from '~/member/api/MemberUpiAccount.ts'
...
useForm('maFormRef').then((form: MaFormExpose) => {
  ...
  form.setItems(getFormItems(formType, t, formModel.value, local))
  form.setOptions({
    labelWidth: '120px',
  })
})
